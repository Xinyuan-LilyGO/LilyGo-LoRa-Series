...
#define RADIO_TYPE_STR              "T-Beam-1W-LR2021"
...
#define FAN_CTRL                    (41)
#define ADC_PIN                     (4)
#define CONFIG_RADIO_2G4_OUTPUT_POWER    8  //注意:WARNING:The 2.4G transmit power must not exceed 8dBm, otherwise it will cause permanent damage to LoRa.
